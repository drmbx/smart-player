...
class ExportService:
    def export_to_csv(self, detections: list[dict], output_path: str, class_names: dict | None = None) -> str:
    ...
    def export_to_images(self, detections: list[dict], output_dir: str, class_names: dict | None = None,
